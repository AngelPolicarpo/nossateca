...
- Orquestracao legacy: search/orchestrator.rs.
- Orquestracao Discover/Source: commands/discover.rs.
- Contratos: wit/search-plugin.wit (legacy) e wit/discover-source-plugin.wit (novo).
...
- Legacy Search: search-books (compatibilidade com fluxo search_books existente).
...
6. Fluxo search_books antigo continua ativo apenas para plugins Legacy Search.
...
- search_books legado e Discover/Source coexistem no runtime; backlog futuro pode remover fluxo legado quando migracao de UI estiver concluida.
